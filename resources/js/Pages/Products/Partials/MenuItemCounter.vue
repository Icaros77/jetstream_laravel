<template>
    <div class="sm:w-full flex flex-col">
        ...
        <div class="flex justify-center items-center h-16" v-show="quantity > 0">
            <button
                type="button"
                class="inline-block text-center font-bold h-full w-1/3"
               
            >
                <svg
                    version="1.1"
                    id="Capa_1"
                    class="w-full h-full  fill-current text-red-400"
